...
* The CLI supports `dump` and `xml`. The fixture corpus is regenerated by the
  ...
  published CLI. The synthetic corpus covers 13 fixtures: KVS topology, tail
  emission, false EBML magic in PCM, multiple clusters and segments, tagless
  and filtered streams, gaps,
