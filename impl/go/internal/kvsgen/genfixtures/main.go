...
import (
	...
	"github.com/yacchi/ebml/impl/go/internal/ebmltrace"
...
func main() {
	...
	fs.Usage = func() {
		...
		fmt.Fprintln(os.Stderr, "  Regenerate fixtures/kvs, golden/kvs and README.json. Run from the impl/go/ directory.")
		fs.PrintDefaults()
	}
